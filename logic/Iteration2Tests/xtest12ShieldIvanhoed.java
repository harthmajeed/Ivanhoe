...
public class xtest12ShieldIvanhoed {
	...
	public void test() {
		...
		Card p2Card3 = new Card("Action", 0, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false);
		Card p3Card1 = new Card("Action", 0, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false);
		...
		assertEquals(true, game.getPlayerArray().get(1).isSheilded());
	    //player 3 plays ivanhoe
		game.update(2, 0);
		//sheild undone
		assertEquals(false, game.getPlayerArray().get(1).isSheilded());
