...
public class xtest12RiposteThrownAway {
	...
	public void test() {
		...
		Card p2Card = new Card("Action", 0, false, false, false, false, false, false, false, false, false, true, false, false, false, false, false, false, false, false, false);
		p1Hand.add(p1Card);
		p1Hand.add(p1Card2);
		p2Hand.add(p2Card);
		...
		assertEquals(5, game.getPlayerArray().get(1).getPlayedValue());
		
		//player 2 only has the card he drew when his turn started left in his hand, riposte is gone
