...
public class test9yellow {
	...
	public void test() {
		...
		//create yellow card
		Card card1 = new Card("Yellow", 3, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
		//add yellow card to player 1's hand to ensure he can start a yellow tournament
		...
		//player 1 has to play card to remain in tournament(play yellow card).
		game.update(0, 9);
		...
		//Player 1 won the tournament, he is awarded yellow token.
