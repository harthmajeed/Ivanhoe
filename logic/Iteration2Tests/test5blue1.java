...
public class test5blue1 {
	...
	public void test() {
		...
		//create a new card array to hold the supporter.
		ArrayList<Card> p1Hand = new ArrayList<Card>();
		//add supporter to new array
		p1Hand.add(card1);
		...
		//player 1 has to play card to remain in tournament(play supporter card).
		game.update(0, 0);
