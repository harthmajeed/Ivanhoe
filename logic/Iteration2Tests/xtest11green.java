...
public class xtest11green{
	...
	public void test() {
		...
		Card bCard1 = new Card("Green", 1, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
		...
		game.startGame();
		game.getPlayerArray().get(0).setpToken(true);
		...
		game.update(1, true);
		game.update(0, false);
		assertEquals(false, game.getPlayerArray().get(0).hasPToken());
