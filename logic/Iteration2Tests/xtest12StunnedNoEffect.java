...
public class xtest12StunnedNoEffect {
	...
	public void test() {
		...
		//set player 2 to stunned
		game.getPlayerArray().get(1).setStunned(true);
		//player 1 tries to play stunned on player 2
		game.update(0, 0);
		//stunned has no effect and is not played.
