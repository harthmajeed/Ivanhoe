...
public class xtest12OutmaneuverThrownAway {
	...
	public void test() {
		...
		//player 3 has only the blue card and the card he drew when his turn started left in his hand
		assertEquals(2, game.getPlayerArray().get(2).getHand().size());
		//player 3 has no cards in his display or face up
