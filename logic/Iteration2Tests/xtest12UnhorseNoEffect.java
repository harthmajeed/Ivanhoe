...
public class xtest12UnhorseNoEffect {
	...
	public void test() {
		...
		Card sCard = new Card("Blue", 5, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
		...
		//player 1 tries to play unhorse
		game.update(0, 1);
		//unhorse has no effect and is not played
