...
public class test6green {
	...
	public void test() {
		...
		Card p2card4 = new Card("White", 3, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
		...
		game.update(1, 0);
		game.update(1, 0);
		//since all cards count as 1 in a green tournament, player 2 must play at least 2 cards to remain in tournament
		game.update(1, true);
		game.update(0, 0);
		game.update(0, 0);
		game.update(0, true);
		...
		game.update(1, 0);
		game.update(0, true);
		assertEquals(3, game.getPlayerArray().get(0).getPlayedValue());
