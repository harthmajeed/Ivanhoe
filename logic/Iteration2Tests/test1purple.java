...
public class test1purple {
	...
	public void test() {
		...
		//create purple card
		Card card1 = new Card("Purple", 3, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
		//add purple card to player 1's hand to ensure he can start a purple tournament
		...
		//player 1 has to play card to remain in tournament(play purple card).
		game.update(0, 9);
