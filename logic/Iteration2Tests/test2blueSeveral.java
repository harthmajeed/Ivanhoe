...
public class test2blueSeveral {
	...
	public void test() {
		...
		Card p2card1 = new Card("Blue", 2, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
		...
		game.update(0, true);
		//it is now player 2's turn, he draws a card thus his hand contains the 8 original cards plus the drawn card plus the 3 added cards total = 12.
		assertEquals(true, game.getPlayerArray().get(1).isMyTurn());
		assertEquals (12, game.getPlayerArray().get(1).getHand().size());
		//player 2 plays 3 cards(blue 2's).
		game.update(1, 8);
		game.update(1, 8);
		game.update(1, 8);
		//player 2 ends turn.
